...
export class AuthService {
  ...
  updForm(regdata) {
    return this.http.post('https://willdo.com.ua/p/api/model/k2users/event/updreg/', regdata).pipe(
      tap(res => {
        return res;
      }),
    );
  ...
  async updFormNative(regdata){
    return this.http2.post('https://willdo.com.ua/p/api/model/k2users/event/updreg', regdata, {
      'Content-Type': 'aplication/json'
    })
  }

  orderForm(regdata) {
    return this.http.post('https://willdo.com.ua/p/api/model/wdo_tasks/event/newtask', regdata).pipe(
      tap(res => {
        return res;
      }),
    );
  ...
  async orderFormNative(regdata){
    return this.http2.post('https://willdo.com.ua/p/api/model/wdo_tasks/event/newtaskn', regdata, {
      'Content-Type': 'aplication/json'
    })
  }
}
